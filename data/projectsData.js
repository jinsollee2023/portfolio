    ...
    myFunctions: [
      {
        ...
        desc: [
          ...
          "라우트의 지연 로딩을 통해 초기 로딩 시간을 약 10% 단축",
    ...
    myFunctions: [
      {
        ...
        desc: [
          "React router를 사용해 비로그인과 로그인에 따른 페이지 접근 제한",
          "라우트의 지연 로딩을 통해 초기 로딩 시간을 약 35% 단축",
          "Error Boundary를 이용하여 비동기 호출에서 발생하는 에러 관리",
        ],
      },
      {
        ...
        desc: [
          ...
          "useInfiniteQuery, useInView를 사용하여 무한스크롤 기능을 통해 게시물 데이터 로딩 속도 단축",
          "react-quill 텍스트 편집기를 사용하여 자유롭게 글을 작성할 수 있도록 하며 사진 및 동영상 업로드 첨부 가능하도록 구현",
      ...
      },
      {
        ...
        desc: [
          ...
          "대댓글은 원 댓글 바로 아래에 소규모 들여쓰기와 함께 표시되며, 시간순 정렬",
